 ...
 * @param {SeqGraphQL} opt - object with all information needed for gqlize and our node-platform lib.
 */
...
const generateName = (nameTemplate = '', map = {}, options = {}) => {
  ...
  return camelCase(str, { pascalCase: str[0].toLowerCase().endsWith('input') ? true : options.pascalCase });
